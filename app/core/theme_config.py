...
LightTheme = ft.Theme(color_scheme=ft.ColorScheme(**_light_color_palette), text_theme=_light_text_theme)


DarkTheme = ft.Theme(color_scheme=ft.ColorScheme(**_dark_color_palette), text_theme=_dark_text_theme)
