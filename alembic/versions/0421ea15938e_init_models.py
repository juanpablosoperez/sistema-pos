...
def upgrade() -> None:
    ...
    op.create_table('egresos_compras',
    ...
    sa.ForeignKeyConstraint(['id_egreso'], ['egresos.id_egreso'], ),
    ...
    op.create_table('egresos_gastos',
    ...
    op.create_table('egresos_servicios',
    ...
    op.create_table('egresos_compras_items',
    sa.Column('id_item', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('subtotal', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('total', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.ForeignKeyConstraint(['id_egreso_compra'], ['egresos_compras.id_egreso_compra'], ),
    sa.ForeignKeyConstraint(['id_producto'], ['productos.id_producto'], ),
    sa.PrimaryKeyConstraint('id_item')
    )
